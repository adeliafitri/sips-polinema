                    ...
                    <div class="card card-primary card-tabs">
                        <div class="card-header p-0 pt-1">
                          <ul class="nav nav-tabs justify-content-center" id="custom-tabs-one-tab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" role="tab"  data-toggle="pill" href="#cpmk-tab" aria-controls="cpmk-tab" aria-selected="false" onclick="detailCpmk({{ $data->id_rps }});"><h6 style="font-weight: bold">Indikator Kinerja CPL</h6></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" role="tab"  data-toggle="pill" href="#subcpmk-tab" aria-controls="subcpmk-tab" aria-selected="false" onclick="detailSubCpmk({{ $data->id_rps }});"><h6 style="font-weight: bold">Data CPMK</h6></a>
                            </li>
                            <li class="nav-item">
