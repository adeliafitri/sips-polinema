        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('dosen.user', ['id' => $data->id_auth]) }}">Profil User</a></li>
            ...
            <div class="card">
              ...
              <div class="card-header d-flex justify-content-end">
                ...
                <form id="editDataForm" enctype="multipart/form-data">
                    ...
                    <a href="{{ route('dosen.user.changePass') }}" class="text-danger">Ubah Password</a>
                    {{-- <div class="form-group">
                ...
                <div class="card-footer clearfix">
                    <a href="{{ route('dosen.user', ['id' => $data->id_auth]) }}" class="btn btn-default">Batal</a>
                        ...
                        if (response.status === 'success') {
                            ...
                            icon: "success"
                                ...
                                if (result.isConfirmed) {
                                    ...
                                    window.location.href = "{{ route('dosen.user', ['id' => $data->id_auth]) }}";
                                };
