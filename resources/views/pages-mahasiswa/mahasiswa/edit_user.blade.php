        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('mahasiswa.user', ['id' => $data->id_auth]) }}">Profil User</a></li>
          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-header d-flex justify-content-end">
                <h3 class="card-title col align-self-center">Form Edit Profil</h3>
              </div>
                <div class="card-body">
                <form id="editDataForm" enctype="multipart/form-data">
                    ...
                    <a href="{{ route('mahasiswa.user.changePass') }}" class="text-danger">Ubah Password</a>
                    {{-- <div class="form-group">
                ...
                <div class="card-footer clearfix">
                    <a href="{{ route('mahasiswa.user', ['id' => $data->id_auth]) }}" class="btn btn-default">Batal</a>
    ...
    <script>
        function editData(id){
            ...
            if (result.isConfirmed) {
                    $.ajax({
                    url: "{{ url('mahasiswa/user/edit') }}/" + id,
                    type: 'POST',
                    headers: {
                        ...
                        if (response.status === 'success') {
                            ...
                            icon: "success"
                                ...
                                if (result.isConfirmed) {
                                    ...
                                    window.location.href = "{{ route('mahasiswa.user', ['id' => $data->id_auth]) }}";
                                };
