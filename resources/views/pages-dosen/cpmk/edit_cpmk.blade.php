...
if(isset($_GET['data'])){
	$id_cpmk = $_GET['data'];
	$_SESSION['id_cpmk']=$id_cpmk;
	//get data cpmk
	$sql_m = "SELECT `kode_cpmk`,`deskripsi`, `matakuliah_id`, `cpl_id` FROM `cpmk` WHERE `id`='$id_cpmk'";
	$query_m = mysqli_query($koneksi,$sql_m);
	while($data_m = mysqli_fetch_row($query_m)){
		$kode_cpmk = $data_m[0];
		$deskripsi = $data_m[1];
    $matakuliah_id = $data_m[2];
    $cpl_id = $data_m[3];
	}
}
?>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php?include=data-cpl">Data CPMK</a></li>
          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-header d-flex justify-content-end">
                ...
                <div class="card-body">
                <form action="index.php?include=proses-edit-cpmk" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    <label for="cpl">cpl</label>
                        ...
                        while($data_k = mysqli_fetch_row($query_k)){
                                ...
                                $kode_cpl = $data_k[1];
                        ?>
                        <option value="<?php echo $id_cpl;?>" <?php if($id_cpl==$cpl_id){?>
                        selected <?php }?>><?php echo $kode_cpl;?></option>
                        <?php }?>
                        </select>
                  </div>
                  <div class="form-group">
                    <label for="kode_cpmk">Kode CPMK</label>
                    <input type="text" class="form-control" id="kode_cpmk" name="kode_cpmk" placeholder="Kode CPMK" value="<?php echo $kode_cpmk;?>">
                  </div>
                  <div class="form-group">
