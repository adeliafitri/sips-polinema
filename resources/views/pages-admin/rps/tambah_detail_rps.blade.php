                                            ...
                                            <div class="row">
                                                <div class="col-md-5">
                                                    ...
                                                    <div class="col-md-12 mb-3 d-flex">
                                                        ...
                                                        <div class="col-md-8">
                                                            <button class="btn btn-sm btn-primary" type="button" onclick="inputCpl({{ $id }}, '{{ $name }}')"><i class="nav-icon fas fa-plus mr-2"></i> Tambah Indikator</button>
                                                        </div>
                                                    </div>
                                                    @endforeach
                                                </div>
                                                <div class="col-md-7">
                                                    <form enctype="multipart/form-data" id="formCpmk">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="kode_cpmk" name="kode_cpmk" placeholder="Kode Indikator Kinerja CPL" required>
                                                        </div>
                                                    ...
                                                    <form enctype="multipart/form-data" id="formSubCpmk">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="kode_subcpmk"
                                                                name="kode_subcpmk" placeholder="Kode CPMK">
                                                        </div>
                                                        <div class="textinput" style="margin-bottom: 1rem">
